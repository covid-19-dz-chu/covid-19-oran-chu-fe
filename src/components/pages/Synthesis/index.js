...
const mapDispatchToProps = (dispatch) => ({
  ...
  onChangeField: (key, value) =>
    dispatch({ type: UPDATE_FIELD_SYNTHESIS, key, value }),
});
...
class Synthesis extends Component {
  ...
  onSubmit = (ev) => {
    ...
    if (Object.keys(errors).length === 0) {
      ...
      this.props.onSubmit(
        patientsRequest.getPatientByReference(this.props.synthesis.synthesisNum)
      );
    }
  };
  ...
  render() {
    ...
    return (
      <div>
        ...
        <p>
          Veuillez entrer le billet de salle et génerer la synthese de ce
          dernier
        </p>
        <div className="synthesis-search">
          <form onSubmit={this.onSubmit}>
            <br />
            <fieldset>
              <label className="full-width form-label" htmlFor="patientNumber">
              ...
              <div className="row">
                <div className="col-10">
                  <input
                    ...
                    value={synthesisNum || ''}
                    onChange={(ev) => {
                      this.props.onChangeField('synthesisNum', ev.target.value);
                    }}
                ...
                <div className="col-2">
                  <button
                    className="btn btn-lg btn-primary pull-lg-right full-width"
                    type="submit"
                  >
                    <small>Search</small>
                  </button>
