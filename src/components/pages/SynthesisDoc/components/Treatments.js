    ...
    <section>
      ...
      <Container>
        {synthesis &&
          ...
          synthesis.treatments.map((treatment, key) => {
            return (
              <div className="section-item" key={key}>
                <Row>
                  <Col>
                    <p>
                      <strong>Date: </strong>
                      {new Date(treatment.date).toLocaleString('fr-FR')}
                    </p>
                  </Col>
                  <Col>
                    <p>
                      <strong>Ajouté par:</strong> {treatment.addedBy}
                    </p>
                  </Col>
                </Row>
                <Row>
                ...
                <Row>
                  <Col>
                    <p>
                      <strong>Hydroxychloroquine: </strong>
