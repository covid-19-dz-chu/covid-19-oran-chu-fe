      ...
      <Container>
        {synthesis && synthesis.biologics && synthesis.biologics.map((biologic ,key) => {
          return (
            ...
            <Row>
            <Col>
              <p><strong>Date: </strong>{new Date(biologic.date).toLocaleString('fr-FR')}</p>
            </Col>
            <Col>
          ...
          <Row>
            ...
            <Col>
              <p><strong>GB: </strong>{biologic.nfs.gb} 10<sup>3</sup>/mm<sup>3</sup></p>
              <p><strong>Hb: </strong>{biologic.nfs.hemoglobin.hb} g/dl</p>
              <p><strong>Plt: </strong>{biologic.nfs.plt} 10<sup>3</sup>/mm<sup>3</sup></p>
            </Col>
            <Col>
            <p><strong>PNN: </strong>{biologic.nfs.pnn} 10<sup>3</sup>/mm<sup>3</sup></p>
            <p><strong>VGM: </strong>{biologic.nfs.hemoglobin.vgm} μ<sup>3</sup></p>
            <p><strong>Hte: </strong>{biologic.nfs.hte} %</p>
            </Col>
            <Col>
            <p><strong>Lym: </strong>{biologic.nfs.lym} 10<sup>3</sup>/mm<sup>3</sup></p>
